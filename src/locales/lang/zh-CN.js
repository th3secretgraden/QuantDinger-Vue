...
const locale = {
  ...
  'trading-bot.newIndicatorStrategy': '新建指标策略',
  'trading-bot.newScriptStrategy': '新建 Python 脚本策略',
  'trading-bot.emptyHint': '可先创建指标信号策略，或在此新建 Python 脚本策略并部署运行',
  ...
  'dashboard.indicator.market.PredictionMarket': '预测市场',
  ...
  'indicatorIde.aiExperimentEmpty': '在「智能调参」标签页可运行「运行智能调参」（AI 提案）或「结构化扫参」（网格/随机批量回测）。左侧「AI 生成」用于自然语言写代码。结果仅供参考，请结合样本外与风控验证。',
  'indicatorIde.aiExperimentNeedBacktestParams': '请先选择标的并准备好代码与回测区间',
  'indicatorIde.aiExperimentTab': '智能调参',
  'indicatorIde.runStructuredTune': '结构化扫参（不调 AI）',
