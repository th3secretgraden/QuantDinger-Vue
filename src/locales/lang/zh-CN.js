...
const locale = {
  ...
  'menu.dashboard.polymarket': '预测市场',
  'menu.settings': '系统设置',
  ...
  'aiAssetAnalysis.opportunities.market.PredictionMarket': '🎯 预测市场',
  ...
  'backtest-center.indicator.noIndicators': '暂无自定义指标，请先在指标分析页面创建',
  'backtest-center.indicator.runBacktest': '开始回测',
  'backtest-center.indicator.history': '历史记录',
  'backtest-center.indicator.goToIndicator': '前往指标分析',
  ...
  'trading-assistant.empty.desc': '先创建一个策略，再选择运行方式。若选择“实盘自动交易”，策略就会出现在“实盘概览”中。',
  'trading-assistant.empty.path': '建议先创建第一条策略，再逐步补充交易所连接与通知设置。',
  ...
  'trading-assistant.form.advancedModeHint': '适合配置止盈止损、仓位管理与AI过滤',
  ...
  'trading-assistant.form.simpleModePresetValue': '默认采用 15m / 合约 / 5x，止盈止损和仓位管理可在高级模式继续补充。',
  'trading-assistant.form.simpleModeSectionCore': '核心交易设置',
  'trading-assistant.form.simpleModeSectionCoreDesc': '先完成交易对与资金配置，再决定是否开启实盘或补充高级风控。',
  ...
  'trading-assistant.strategyMode.signalDesc': '基于现有指标做买卖信号和风控配置，不需要手写代码，适合先快速搭建第一套策略。',
  ...
  'trading-assistant.strategyMode.signalFeature2': '可视化配置止盈、止损和执行模式',
  ...
  'trading-assistant.template.gridDesc': '在价格区间内挂等距买卖单，适合震荡行情',
  ...
  'trading-assistant.editor.aiHint': '这里是基于你输入描述生成或改写策略代码的助手。建议先用模板起步，再让 AI 帮你优化细节。',
  ...
  'polymarket.subtitle': '基于Polymarket预测市场数据的AI分析和交易机会推荐',
  'polymarket.filter.category': '选择类别',
  'polymarket.filter.sortBy': '排序方式',
  'polymarket.sort.volume': '24小时交易量',
  'polymarket.sort.aiScore': 'AI机会评分',
  'polymarket.sort.highProbability': '高概率机会',
  'polymarket.sort.highReturn': '高回报比机会',
  'polymarket.search.placeholder': '搜索预测市场...',
  'polymarket.category.all': '全部',
  'polymarket.category.crypto': '加密货币',
  'polymarket.category.politics': '政治',
  'polymarket.category.economics': '经济',
  'polymarket.category.sports': '体育',
  'polymarket.category.tech': '科技',
  'polymarket.category.finance': '金融',
  'polymarket.category.geopolitics': '地缘政治',
  'polymarket.category.culture': '文化',
  'polymarket.category.climate': '气候',
  'polymarket.category.entertainment': '娱乐',
  'polymarket.market.currentProbability': '当前概率',
  'polymarket.ai.predicted': 'AI预测概率',
  'polymarket.ai.marketProbability': '市场概率',
  'polymarket.ai.recommendation': 'AI推荐',
  'polymarket.ai.confidence': '置信度',
  'polymarket.ai.opportunityScore': '机会评分',
  'polymarket.ai.reasoning': '分析理由',
  'polymarket.ai.keyFactors': '关键因素',
  'polymarket.recommendation.YES': 'YES（看涨）',
  'polymarket.recommendation.NO': 'NO（看跌）',
  'polymarket.recommendation.HOLD': 'HOLD（中性）',
  'polymarket.status.active': '活跃',
  'polymarket.status.closed': '已关闭',
  'polymarket.status.resolved': '已结算',
  'polymarket.action.viewDetail': '查看详情',
  'polymarket.action.viewOnPolymarket': '在Polymarket查看',
  'polymarket.detail.title': '预测市场详情',
  'polymarket.detail.currentProbability': '当前概率',
  'polymarket.detail.volume24h': '24小时交易量',
  'polymarket.detail.liquidity': '流动性',
  'polymarket.detail.aiAnalysis': 'AI分析结果',
  'polymarket.detail.assetOpportunities': '相关资产交易机会',
  'polymarket.opportunity.confidence': '置信度',
  'polymarket.opportunity.analyze': '分析资产',
  'polymarket.signal.BUY': '买入',
  'polymarket.signal.SELL': '卖出',
  'polymarket.signal.HOLD': '持有',
  'polymarket.error.loadFailed': '加载市场列表失败',
  'polymarket.error.searchFailed': '搜索失败',
  'polymarket.error.notFound': '未找到市场数据',
  'polymarket.error.loadDetailFailed': '加载详情失败',
  'polymarket.viewOnPolymarket': '在Polymarket查看',
  'polymarket.filter.explanation.title': '筛选依据说明',
  'polymarket.filter.explanation.volume': '按24小时交易量排序，显示最活跃的预测市场。',
  'polymarket.filter.explanation.aiScore': '按AI机会评分排序，综合考虑AI与市场差异、置信度等因素，优先显示高价值机会。',
  'polymarket.filter.explanation.highProbability': '按AI预测概率排序，优先显示AI认为发生概率较高的事件（AI预测概率 > 市场概率 + 10%）。',
  'polymarket.filter.explanation.highReturn': '按高回报比排序，优先显示AI与市场差异大且置信度高的机会（差异 × 置信度），适合寻找被低估的预测。',
  'polymarket.deepAnalysis.prompt': '当前显示的是基于规则的简单分析。点击下方按钮进行AI深度分析，获得更准确的预测和建议。',
  'polymarket.deepAnalysis.button': '深度分析',
  'polymarket.deepAnalysis.success': '深度分析完成！消耗积分 {credits}，剩余积分 {remaining}',
  'polymarket.deepAnalysis.successFree': '深度分析完成！',
  'polymarket.deepAnalysis.failed': '深度分析失败，请稍后重试',
  'polymarket.deepAnalysis.insufficientCredits': '积分不足！需要 {required} 积分，当前 {current} 积分，缺少 {shortage} 积分',
  ...
  'polymarket.analysis.inputRequired': '请输入Polymarket链接或市场标题',
  'polymarket.analysis.analyzeButton': '开始分析',
  'polymarket.analysis.analyzing': '正在分析中，请稍候...',
  'polymarket.analysis.success': '分析完成！',
  'polymarket.analysis.failed': '分析失败，请稍后重试',
  'polymarket.analysis.insufficientCredits': '积分不足，请先充值',
  'polymarket.analysis.viewOnPolymarket': '在Polymarket查看',
  'polymarket.analysis.aiAnalysis': 'AI分析结果',
  'polymarket.analysis.marketProbability': '市场概率',
  'polymarket.analysis.aiPredictedProbability': 'AI预测概率',
  'polymarket.analysis.divergence': '差异',
  'polymarket.analysis.recommendation': '推荐',
  'polymarket.analysis.recommendationYes': 'YES（看涨）',
  'polymarket.analysis.recommendationNo': 'NO（看跌）',
  'polymarket.analysis.recommendationHold': 'HOLD（中性）',
  'polymarket.analysis.confidenceScore': '置信度',
  'polymarket.analysis.opportunityScore': '机会评分',
  'polymarket.analysis.reasoning': '分析理由',
  'polymarket.analysis.keyFactors': '关键因素',
  'polymarket.analysis.creditsCharged': '本次分析消耗积分：{credits}',
  'polymarket.analysis.remainingCredits': '剩余积分：{credits}',
  'polymarket.analysis.newAnalysis': '新分析',
  'polymarket.analysis.tabAnalyze': '分析',
  'polymarket.analysis.tabHistory': '历史记录',
  'polymarket.analysis.historyMarket': '市场',
  'polymarket.analysis.historyRecommendation': '推荐',
  'polymarket.analysis.historyOpportunityScore': '机会评分',
  'polymarket.analysis.historyCreatedAt': '分析时间',
  'polymarket.analysis.historyTotal': '共 {total} 条记录',
  'polymarket.analysis.loadHistoryFailed': '加载历史记录失败',
