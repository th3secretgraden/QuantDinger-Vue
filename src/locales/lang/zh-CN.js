...
const locale = {
  ...
  'trading-bot.wizard.symbolPh': '例如：BTC/USDT',
  'trading-bot.wizard.symbolReq': '请输入交易对',
  ...
  'indicatorIde.toolbar.workspace': '工作区',
  ...
  'indicatorIde.aiExperimentEmpty': '切换到「回测与结果」页签后，在「智能调参」子标签可运行「运行智能调参」（AI 提案）或「结构化扫参」（网格/随机批量回测）。左侧「AI 生成」用于自然语言写代码。结果仅供参考，请结合样本外与风控验证。',
