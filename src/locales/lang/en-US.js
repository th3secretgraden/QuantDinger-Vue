...
const locale = {
  ...
  'trading-bot.wizard.symbolPh': 'e.g. BTC/USDT',
  'trading-bot.wizard.symbolReq': 'Please enter a trading pair',
  ...
  'indicatorIde.toolbar.workspace': 'Workspace',
  ...
  'indicatorIde.aiExperimentEmpty': 'Open the Backtest & Results tab, then in the Smart Tuning sub-tab run Smart Tuning (LLM proposals) or Structured scan (grid/random batch backtests). Use AI Generate on the left for natural-language code. For research only—validate out-of-sample and risk limits.',
