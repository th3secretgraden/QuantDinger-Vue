...
const locale = {
  ...
  'trading-bot.newIndicatorStrategy': 'New indicator strategy',
  'trading-bot.newScriptStrategy': 'New Python script strategy',
  'trading-bot.emptyHint': 'Create an indicator signal strategy, or add a Python script strategy here and run it as a bot',
  ...
  'dashboard.indicator.market.PredictionMarket': 'Prediction Market',
  ...
  'indicatorIde.aiExperimentEmpty': 'In the Smart Tuning tab, run Smart Tuning (LLM proposals) or Structured scan (grid/random batch backtests). Use AI Generate on the left for natural-language code. For research only—validate out-of-sample and risk limits.',
  ...
  'indicatorIde.runStructuredTune': 'Structured scan (no LLM)',
