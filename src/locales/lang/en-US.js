...
const locale = {
  ...
  'menu.dashboard.polymarket': 'Prediction Markets',
  ...
  'aiAssetAnalysis.opportunities.market.PredictionMarket': '🎯 Prediction Market',
  ...
  'backtest-center.indicator.noIndicators': 'No custom indicators yet. Create one in Indicator Analysis first.',
  'backtest-center.indicator.runBacktest': 'Run Backtest',
  'backtest-center.indicator.history': 'History',
  'backtest-center.indicator.goToIndicator': 'Go to Indicator Analysis',
  ...
  'trading-assistant.empty.desc': 'Create your first strategy, then choose its execution mode. If you select "Live Trading", it will appear in the Live Overview tab.',
  'trading-assistant.empty.path': 'Recommended first step: create one strategy, then add exchange connection and notification settings.',
  ...
  'trading-assistant.form.advancedModeHint': 'Best for TP/SL, position sizing and AI filter configuration',
  ...
  'trading-assistant.form.simpleModePresetValue': 'Starts with 15m / Futures / 5x. You can add TP/SL and position management later in Advanced mode.',
  'trading-assistant.form.simpleModeSectionCore': 'Core trading setup',
  'trading-assistant.form.simpleModeSectionCoreDesc': 'Finish pair and capital settings first, then decide whether to enable live trading or add advanced risk controls.',
  ...
  'trading-assistant.strategyMode.signalDesc': 'Build a strategy from existing indicators and visual risk settings. No coding required, ideal for getting your first strategy online quickly.',
  ...
  'trading-assistant.strategyMode.signalFeature2': 'Visual TP/SL, execution mode, and risk settings',
  ...
  'trading-assistant.template.gridDesc': 'Place equidistant buy/sell orders within a price range, ideal for ranging markets',
  ...
  'trading-assistant.editor.aiHint': 'This assistant can generate new code or revise the current strategy. A good workflow is: start from a template, then ask AI to refine it.',
  ...
  'quickTrade.tpsl': 'TP/SL Price (Optional)',
  ...
  'polymarket.subtitle': 'AI analysis and trading opportunity recommendations based on Polymarket prediction market data',
  'polymarket.filter.category': 'Select Category',
  'polymarket.filter.sortBy': 'Sort By',
  'polymarket.sort.volume': '24h Volume',
  'polymarket.sort.aiScore': 'AI Opportunity Score',
  'polymarket.sort.highProbability': 'High Probability',
  'polymarket.sort.highReturn': 'High Return Ratio',
  'polymarket.search.placeholder': 'Search prediction markets...',
  'polymarket.category.all': 'All',
  'polymarket.category.crypto': 'Cryptocurrency',
  'polymarket.category.politics': 'Politics',
  'polymarket.category.economics': 'Economics',
  'polymarket.category.sports': 'Sports',
  'polymarket.category.tech': 'Tech',
  'polymarket.category.finance': 'Finance',
  'polymarket.category.geopolitics': 'Geopolitics',
  'polymarket.category.culture': 'Culture',
  'polymarket.category.climate': 'Climate',
  'polymarket.category.entertainment': 'Entertainment',
  'polymarket.market.currentProbability': 'Current Probability',
  'polymarket.ai.predicted': 'AI Predicted Probability',
  'polymarket.ai.marketProbability': 'Market Probability',
  'polymarket.ai.recommendation': 'AI Recommendation',
  'polymarket.ai.confidence': 'Confidence',
  'polymarket.ai.opportunityScore': 'Opportunity Score',
  'polymarket.ai.reasoning': 'Analysis Reasoning',
  'polymarket.ai.keyFactors': 'Key Factors',
  'polymarket.recommendation.YES': 'YES (Bullish)',
  'polymarket.recommendation.NO': 'NO (Bearish)',
  'polymarket.recommendation.HOLD': 'HOLD (Neutral)',
  'polymarket.status.active': 'Active',
  'polymarket.status.closed': 'Closed',
  'polymarket.status.resolved': 'Resolved',
  'polymarket.action.viewDetail': 'View Details',
  'polymarket.action.viewOnPolymarket': 'View on Polymarket',
  'polymarket.detail.title': 'Prediction Market Details',
  'polymarket.detail.currentProbability': 'Current Probability',
  'polymarket.detail.volume24h': '24h Volume',
  'polymarket.detail.liquidity': 'Liquidity',
  'polymarket.detail.aiAnalysis': 'AI Analysis Results',
  'polymarket.detail.assetOpportunities': 'Related Asset Trading Opportunities',
  'polymarket.opportunity.confidence': 'Confidence',
  'polymarket.opportunity.analyze': 'Analyze Asset',
  'polymarket.signal.BUY': 'BUY',
  'polymarket.signal.SELL': 'SELL',
  'polymarket.signal.HOLD': 'HOLD',
  'polymarket.error.loadFailed': 'Failed to load markets',
  'polymarket.error.searchFailed': 'Search failed',
  'polymarket.error.notFound': 'Market not found',
  'polymarket.error.loadDetailFailed': 'Failed to load details',
  'polymarket.viewOnPolymarket': 'View on Polymarket',
  'polymarket.filter.explanation.title': 'Filter Explanation',
  'polymarket.filter.explanation.volume': 'Sorted by 24h trading volume, showing the most active prediction markets.',
  'polymarket.filter.explanation.aiScore': 'Sorted by AI opportunity score, considering AI-market divergence, confidence, and other factors. High-value opportunities are prioritized.',
  'polymarket.filter.explanation.highProbability': 'Sorted by AI predicted probability, prioritizing events with high AI probability (AI prediction > market probability + 10%).',
  'polymarket.filter.explanation.highReturn': 'Sorted by high return ratio, prioritizing opportunities with large AI-market divergence and high confidence (divergence × confidence). Suitable for finding undervalued predictions.',
  'polymarket.deepAnalysis.prompt': 'Currently showing rule-based simple analysis. Click the button below for AI deep analysis to get more accurate predictions and recommendations.',
  'polymarket.deepAnalysis.button': 'Deep Analysis',
  'polymarket.deepAnalysis.success': 'Deep analysis completed! Credits charged: {credits}, Remaining: {remaining}',
  'polymarket.deepAnalysis.successFree': 'Deep analysis completed!',
  'polymarket.deepAnalysis.failed': 'Deep analysis failed, please try again later',
  'polymarket.deepAnalysis.insufficientCredits': 'Insufficient credits! Required: {required}, Current: {current}, Shortage: {shortage}',
  ...
  'polymarket.analysis.inputRequired': 'Please enter a Polymarket link or market title',
  'polymarket.analysis.analyzeButton': 'Start Analysis',
  'polymarket.analysis.analyzing': 'Analyzing, please wait...',
  'polymarket.analysis.success': 'Analysis completed!',
  'polymarket.analysis.failed': 'Analysis failed, please try again later',
  'polymarket.analysis.insufficientCredits': 'Insufficient credits, please recharge first',
  'polymarket.analysis.viewOnPolymarket': 'View on Polymarket',
  'polymarket.analysis.aiAnalysis': 'AI Analysis Results',
  'polymarket.analysis.marketProbability': 'Market Probability',
  'polymarket.analysis.aiPredictedProbability': 'AI Predicted Probability',
  'polymarket.analysis.divergence': 'Divergence',
  'polymarket.analysis.recommendation': 'Recommendation',
  'polymarket.analysis.recommendationYes': 'YES (Bullish)',
  'polymarket.analysis.recommendationNo': 'NO (Bearish)',
  'polymarket.analysis.recommendationHold': 'HOLD (Neutral)',
  'polymarket.analysis.confidenceScore': 'Confidence Score',
  'polymarket.analysis.opportunityScore': 'Opportunity Score',
  'polymarket.analysis.reasoning': 'Analysis Reasoning',
  'polymarket.analysis.keyFactors': 'Key Factors',
  'polymarket.analysis.creditsCharged': 'Credits charged for this analysis: {credits}',
  'polymarket.analysis.remainingCredits': 'Remaining credits: {credits}',
  'polymarket.analysis.newAnalysis': 'New Analysis',
  'polymarket.analysis.tabAnalyze': 'Analyze',
  'polymarket.analysis.tabHistory': 'History',
  'polymarket.analysis.historyMarket': 'Market',
  'polymarket.analysis.historyRecommendation': 'Recommendation',
  'polymarket.analysis.historyOpportunityScore': 'Opportunity Score',
  'polymarket.analysis.historyCreatedAt': 'Analysis Time',
  'polymarket.analysis.historyTotal': 'Total {total} records',
  'polymarket.analysis.loadHistoryFailed': 'Failed to load history',
  // AI Asset Analysis - Polymarket Tab
  'aiAssetAnalysis.tabs.polymarket': 'Prediction Markets'
}
